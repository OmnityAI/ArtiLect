...
type ProfileKey = "AI Strategist" | "AI Creator" | "AI Explorer" | "AI Builder";
...
const questions: Question[] = [
  {
    ...
    options: [
      {
        id: "a1",
        text: "Large Language Models (ChatGPT, Claude)",
        value: "llm",
        description: "Advanced conversational AI",
      },
      {
        id: "a2",
        text: "AI Art & Creative Tools",
        value: "creative",
      ...
      },
      {
        ...
        value: "autonomous",
        description: "Self-driving cars, robotics",
      },
      {
        id: "a4",
        text: "AI in Healthcare & Science",
        value: "healthcare",
        description: "Drug discovery, diagnostics",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        value: "learning",
        description: "Need clearer explanations",
      },
      {
        id: "b2",
        text: "Finding practical applications",
        value: "application",
        description: "How to use it in my work",
      },
      {
        id: "b3",
        text: "Keeping up with rapid changes",
        value: "pace",
        description: "Too much happening too fast",
      },
      {
        id: "b4",
        text: "Ethical & safety concerns",
        value: "ethics",
        description: "Worried about implications",
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "c1",
        text: "Social media & news feeds",
        value: "social",
        description: "Twitter, LinkedIn, Reddit",
      },
      {
        id: "c2",
        text: "Academic papers & research",
        value: "academic",
        description: "ArXiv, journals, conferences",
      },
      {
        id: "c3",
        text: "Industry reports & newsletters",
        value: "industry",
        description: "Professional publications",
      },
      {
        id: "c4",
        text: "YouTube & podcasts",
        value: "media",
        description: "Video content & audio shows",
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "d1",
        text: "Business automation & efficiency",
        value: "business",
      ...
      },
      {
        ...
        value: "content",
        description: "Writing, design, campaigns",
      },
      {
        id: "d3",
        text: "Data analysis & insights",
        value: "data",
        description: "Analytics, predictions, patterns",
      },
      {
        id: "d4",
        text: "Software development",
        value: "development",
        description: "Coding assistants, testing",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        value: "global",
        description: "Climate, poverty, disease",
      },
      {
        id: "e2",
        text: "Enhancing human creativity",
        value: "creativity",
        description: "New forms of art & expression",
      },
      {
        id: "e3",
        text: "Democratizing expertise",
        value: "democratization",
        description: "AI tutors, advisors for everyone",
      },
      {
        id: "e4",
        text: "Scientific breakthroughs",
        value: "science",
        description: "Accelerated research & discovery",
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "f1",
        text: "Non-technical professional",
        value: "nontechnical",
        description: "Business, marketing, etc.",
      },
      {
        id: "f2",
        text: "Technical but not AI-focused",
        value: "technical",
        description: "Developer, engineer, analyst",
      },
      {
        id: "f3",
        text: "AI/ML practitioner",
        value: "aiml",
        description: "Data scientist, ML engineer",
      },
      {
        id: "f4",
        text: "AI researcher or academic",
        value: "researcher",
        description: "PhD, research scientist",
      },
    ],
  },
];

const aiProfiles: Record<ProfileKey, AIProfile> = {
  "AI Strategist": {
    title: "The AI Strategist",
    description:
      "You see the big picture of AI transformation. You're focused on how AI will reshape industries and create new opportunities.",
    traits: [
      "Strategic thinking",
      "Business-focused",
      "Future-oriented",
  ...
  "AI Creator": {
    ...
    description:
      "You're passionate about AI as a creative partner. You see AI as a tool to amplify human imagination and artistic expression.",
    traits: [
      "Creative mindset",
      "Innovation-focused",
      "Artistic vision",
    ...
    recommendations: [
      "Creative AI tools reviews",
      "Art generation techniques",
  ...
  "AI Explorer": {
    ...
    description:
      "You're curious about all aspects of AI. You love discovering new developments and understanding how everything connects.",
  ...
  "AI Builder": {
    ...
    description:
      "You're hands-on with AI development. You want to understand the technical details and build practical AI solutions.",
    traits: [
      "Technical expertise",
      "Problem solver",
...
export default function InteractiveQuiz() {
  ...
  const calculateProfile = useCallback((userAnswers: Answer[]): AIProfile => {
    const profileScores: Record<ProfileKey, number> = {
      "AI Strategist": 0,
      "AI Creator": 0,
      "AI Explorer": 0,
      "AI Builder": 0,
    ...
    for (const answer of userAnswers) {
      ...
      if (
        ["business", "global", "nontechnical", "industry", "application"].includes(
          value
        )
      ) {
    ...
    const entries = Object.entries(profileScores) as [ProfileKey, number][];

const [topProfileKey] = entries.reduce<[ProfileKey, number]>(
  (max, cur) => (cur[1] > max[1] ? cur : max),
  entries[0] // <-- initial value fixes the type error
);

return aiProfiles[topProfileKey];
  }, []);
  ...
  const handleNext = useCallback(() => {
    ...
    const newAnswers = [
      ...answers,
      { questionId: shuffledQuestions[currentQuestion].id, selectedOption },
    ];
        ...
        >
          <Card className="border-border/50 bg-card/80 backdrop-blur-sm">
            <CardHeader className="text-center">
              <div
                className={`mx-auto w-16 h-16 rounded-full bg-gradient-to-r ${profile.color} flex items-center justify-center mb-4`}
              >
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        ...
        >
          <Card className="border-border/50 bg-card/80 backdrop-blur-sm">
            <CardHeader className="text-center">
              <div
                className={`mx-auto w-20 h-20 rounded-full bg-gradient-to-r ${profile.color} flex items-center justify-center mb-6`}
              >
            ...
            <CardContent className="space-y-8">
              ...
              <div className="bg-secondary/30 rounded-lg p-4 text-center">
                <p className="text-sm text-muted-foreground mb-2">
                  ✨ <strong>Congratulations!</strong> You're now part of an exclusive
                  community
                </p>
                <p className="text-xs text-muted-foreground">
                  Your first personalized AI newsletter arrives in your inbox within 24
                  hours
                </p>
              </div>
            </CardContent>
