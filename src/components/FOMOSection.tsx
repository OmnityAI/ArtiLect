          ...
          <div className={`transition-all duration-500 ${activeTab === 'missed' ? 'opacity-100 scale-100' : 'lg:opacity-40 lg:scale-95'}`}>
            ...
            <div className="space-y-4">
              {missedContent.map((item, index) => (
                <div key={index} className="group bg-card border border-border rounded-lg p-6 hover:border-primary/50 transition-all duration-300 hover:scale-[1.02]">
          ...
          <div className={`transition-all duration-500 ${activeTab === 'coming' ? 'opacity-100 scale-100' : 'lg:opacity-40 lg:scale-95'}`}>
            ...
            <div className="space-y-4">
              {comingContent.map((item, index) => (
                <div key={index} className="group bg-card border border-border rounded-lg p-6 hover:border-accent/50 transition-all duration-300 relative overflow-hidden hover:scale-[1.02]">
