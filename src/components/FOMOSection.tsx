        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <div
            className={`transition-all duration-500 ${
              activeTab === 'missed' ? 'opacity-100 scale-100' : 'lg:opacity-40 lg:scale-95'
            } ${activeTab === 'missed' ? 'block' : 'hidden'} lg:block`}
          >
          ...
          <div
            className={`transition-all duration-500 ${
              activeTab === 'coming' ? 'opacity-100 scale-100' : 'lg:opacity-40 lg:scale-95'
            } ${activeTab === 'coming' ? 'block' : 'hidden'} lg:block`}
          >
            <div className="flex items-center gap-3 mb-6">
